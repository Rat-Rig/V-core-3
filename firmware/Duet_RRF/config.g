...
M203 X10800.00 Y10800.00 Z1000.00 E1200.00              ; set maximum speeds (mm/min)
M201 X5000.00 Y5000.00 Z100.00 E300.00                  ; set accelerations (mm/s^2)
...
M557 X30:300 Y15:300 S60                                ; define mesh grid
G29 S1

; Heaters
M308 S0 P"temp0" Y"thermistor" T100000 B3950 A"Bed"           ; configure sensor 0 as thermistor on pin temp0
M950 H0 C"out5" T0                                            ; create bed heater output on out5 and map it to sensor 0
...
;M92 E830           ; set extruder steps per mm, 0.9 angle/step
...
M950 H1 C"out0" T1                                                    ; create nozzle heater output on out2 and map it to sensor 1
