...
; Fans
M950 F0 C"out4" Q500                   ; create fan 1 on pin out4 and set its frequency
...
M106 P1 C"Hotend Fan" S0 H1 T45        ; set fan 0 name and value. Thermostatic control turned on for Hotend
